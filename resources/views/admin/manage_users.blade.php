                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{$user->profile->avatar ? asset('img/'.$user->profile->avatar) : asset('img/avatar/person.jpg')}}" class="avatar avatar-xl me-3 border-radius-lg" alt="user1">
                                                    </div>
                                                    <div class="d-flex flex-column justify-content-center">
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{$user->profile->address}}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold">{{$user->profile->contact_no}}</span>
                                            </td>
